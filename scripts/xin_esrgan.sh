...
#SBATCH --job-name=xin_esrgan
#SBATCH --error=xin_esrgan_1.err
#SBATCH --output=xin_esrgan_1.out
...
output_path="/scratch/sayam.choudhary.cse17.iitbhu/output_xin_esrgan"
